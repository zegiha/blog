...
// import {RenewWrapper} from '@/components/_chan/renew/()/RenewWrapper'
// import {IRenew, IRenewSuper, IRenewTextValue} from '@/components/_chan/renew/()/type'
// import useRenewWrapper from '@/components/_chan/renew/()/useRenewWrapper'
...
// export default function(props: IValueTypeText) {
//   const {
//     type: contentType,
//   } = props
//
...
//   return (
//     <>
//       <Row className={style.wrapper} width={'fill-width'}>
//         <div
//           ref={ref}
//           className={cn(
//             style.input,
